...
showMessage = function (message) {
	...
	console.log("This is your reminder.: " + message + ". Don't forget to complete your tasks.");
};

showMessage("This is your reminder."); 
showMessage("Don't forget to complete your tasks."); 
